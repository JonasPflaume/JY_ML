...
def classification_toy_data():
    ...
    data_len = 500
    class_1_X = np.random.normal(loc=class_1_pos[0], scale=np.array([0.9,0.9]), size=(data_len,2))
    
    class_2_X1 = np.random.normal(loc=class_2_pos[0], scale=np.array([0.6,0.9]), size=(data_len//2,2))
    class_2_X2 = np.random.normal(loc=class_2_pos[1], scale=np.array([0.9,0.6]), size=(data_len//2,2))
    
    class_3_X1 = np.random.normal(loc=class_3_pos[0], scale=np.array([0.9,0.9]), size=(data_len//2,2))
    class_3_X2 = np.random.normal(loc=class_3_pos[1], scale=np.array([0.9,0.9]), size=(data_len//2,2))
